...
c$$$ CREATED TEMP MATICIES -> GENERATE A
      CALL ZAXPY(LIMX*LIMX,UNITY,MA,1,A,1)
      CALL ZAXPY(LIMX*LIMX,UNITY,TEMPX,1,A,1)
      CALL ZAXPY(LIMX*LIMX,UNITY,TEMPY,1,A,1)
      CALL ZAXPY(LIMX*LIMX,UNITY,LAMTWO,1,A,1)
c$$$ GENERATE B
      CALL ZAXPY(LIMX*LIMX,UNITY,MA,1,A,1)
      CALL ZAXPY(LIMX*LIMX,NEG,TEMPX,1,A,1)
      CALL ZAXPY(LIMX*LIMX,UNITY,TEMPY,1,A,1)
      CALL ZAXPY(LIMX*LIMX,NEG,LAMTWO,1,A,1)
c$$$  GENERTATE C
      CALL ZAXPY(LIMX*LIMX,UNITY,MA,1,A,1)
      CALL ZAXPY(LIMX*LIMX,UNITY,TEMPX,1,A,1)
      CALL ZAXPY(LIMX*LIMX,NEG,TEMPY,1,A,1)
      CALL ZAXPY(LIMX*LIMX,NEG,LAMTWO,1,A,1)      
c$$$  GENERTATE D
      CALL ZAXPY(LIMX*LIMX,UNITY,MA,1,A,1)
      CALL ZAXPY(LIMX*LIMX,NEG,TEMPX,1,A,1)
